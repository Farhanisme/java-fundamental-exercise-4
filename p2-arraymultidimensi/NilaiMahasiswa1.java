...
public class NilaiMahasiswa1 {
    public static void main(String[] args) {
        ...
        double[] minNilaiAkhir = new double[jumlahMahasiswa];
        double[] akumulasiNilaiAkhir = new double[jumlahMahasiswa];
        double[] rataRataNilaiAkhir = new double[jumlahMahasiswa];
        String[] mataKuliahTertinggi = new String[jumlahMahasiswa];
        String[] mataKuliahTerendah = new String[jumlahMahasiswa];

        for (int i = 0; i < jumlahMahasiswa; i++) {
            System.out.println("Mahasiswa ke-" + (i + 1));

            maxNilaiAkhir[i] = -1.0;
            minNilaiAkhir[i] = 101.0;
            ...
            for (int j = 0; j < jumlahMataKuliah; j++) {
                ...
                akumulasiNilaiAkhir[i] += nilaiAkhir[i][j];
                ...
                if (nilaiAkhir[i][j] > maxNilaiAkhir[i]) {
                    ...
                    mataKuliahTertinggi[i] = mahasiswa[i][j];
                }

                if (nilaiAkhir[i][j] < minNilaiAkhir[i]) {
                    minNilaiAkhir[i] = nilaiAkhir[i][j];
                    mataKuliahTerendah[i] = mahasiswa[i][j];
                }
            }

            rataRataNilaiAkhir[i] = akumulasiNilaiAkhir[i] / jumlahMataKuliah;
        }
        ...
        for (int i = 0; i < jumlahMahasiswa; i++) {
            System.out.println("Mahasiswa ke-" + (i + 1));
            System.out.println("Akumulasi nilai akhir seluruh mata kuliah: " + akumulasiNilaiAkhir[i] + " (Rata-rata nilai: " + rataRataNilaiAkhir[i] + ")");
            System.out.println("Nilai akhir tertinggi: " + maxNilaiAkhir[i] + " (Mata kuliah: " + mataKuliahTertinggi[i] + ")");
            System.out.println("Nilai akhir terendah: " + minNilaiAkhir[i] + " (Mata kuliah: " + mataKuliahTerendah[i] + ")");
        }
